...
public sealed class SpaPodFilterTests : PipeWireTestBase
{
    ...
    private static SpaPodProperty Prop(
        uint key,
        SpaValue value,
        SpaPodPropFlags flags = SpaPodPropFlags.None
    ) => new(key, flags, value);
    ...
    private static SpaChoice Flags(SpaValue value) => new(SpaChoiceType.Flags, value.Type, [value]);

    [TestMethod]
    public void ScalarEquality_MatchesAndMismatches()
    {
        Assert.IsTrue(
            SpaPodFilter.Matches(Obj(Prop(1, new SpaInt(7))), Obj(Prop(1, new SpaInt(7))))
        );
        Assert.IsFalse(
            SpaPodFilter.Matches(Obj(Prop(1, new SpaInt(7))), Obj(Prop(1, new SpaInt(8))))
        );
        Assert.IsFalse(
            SpaPodFilter.Matches(Obj(Prop(1, new SpaInt(7))), Obj(Prop(1, new SpaString("7"))))
        );
    }
    ...
    public void EnumChoices_IntersectOnAnySharedAlternative()
    {
        ...
        Assert.IsTrue(
            SpaPodFilter.Matches(candidate, Obj(Prop(1, Enum(new SpaInt(2), new SpaInt(3)))))
        );
        Assert.IsFalse(
            SpaPodFilter.Matches(candidate, Obj(Prop(1, Enum(new SpaInt(3), new SpaInt(4)))))
        );
    }
    ...
    public void RangeFilters_ContainOrReject()
    {
        ...
        Assert.IsTrue(
            SpaPodFilter.Matches(
                candidate,
                Obj(Prop(1, Range(new SpaInt(44100), new SpaInt(8000), new SpaInt(96000))))
            )
        );
        Assert.IsFalse(
            SpaPodFilter.Matches(
                candidate,
                Obj(Prop(1, Range(new SpaInt(44100), new SpaInt(8000), new SpaInt(44100))))
            )
        );
    }
    ...
    public void StepFilters_ApplyUpstreamModuloSemantics()
    {
        ...
        Assert.IsTrue(
            SpaPodFilter.Matches(
                candidate,
                Obj(
                    Prop(1, Step(new SpaInt(0), new SpaInt(0), new SpaInt(96000), new SpaInt(3000)))
                )
            )
        );
        Assert.IsFalse(
            SpaPodFilter.Matches(
                candidate,
                Obj(
                    Prop(1, Step(new SpaInt(0), new SpaInt(0), new SpaInt(96000), new SpaInt(7000)))
                )
            )
        );
    ...
    public void AnObjectAsAPropertyValue_MustBeEqual_NotIntersected()
    {
        ...
        Assert.IsTrue(
            SpaPodFilter.Matches(
                candidate,
                Obj(Prop(1, Obj(Prop(2, new SpaInt(5)), Prop(3, new SpaInt(6)))))
            ),
            "an identical nested object is equal and should match"
        );
        Assert.IsFalse(
            SpaPodFilter.Matches(candidate, Obj(Prop(1, Obj(Prop(2, new SpaInt(5)))))),
    ...
    public void MandatoryProperties_MustExistOnBothSides()
    {
        ...
        Assert.IsTrue(
            SpaPodFilter.Matches(demanding, Obj(Prop(1, new SpaInt(5)), Prop(2, new SpaInt(6))))
        );
    }
    ...
    public void Fractions_CompareByValueNotRepresentation()
    {
        ...
        Assert.IsTrue(
            SpaPodFilter.Matches(
                Obj(Prop(1, new SpaFraction(1, 2))),
                Obj(Prop(1, new SpaFraction(2, 4)))
            )
        );
        Assert.IsFalse(
            SpaPodFilter.Matches(
                Obj(Prop(1, new SpaFraction(1, 2))),
                Obj(Prop(1, new SpaFraction(1, 3)))
            )
        );
    }
    ...
    public void MalformedChoices_MatchNothingRatherThanThrowing()
    {
        ...
        Assert.ThrowsExactly<ArgumentException>(() =>
            new SpaChoice(SpaChoiceType.Range, SpaType.Int, [new SpaInt(5), new SpaInt(0)])
        );
    }
    ...
    public void StepFilters_SupportLongSteps()
    {
        ...
        Assert.IsTrue(
            SpaPodFilter.Matches(
                candidate,
                Obj(
                    Prop(1, Step(new SpaLong(0), new SpaLong(0), new SpaLong(100), new SpaLong(10)))
                )
            )
        );
        Assert.IsFalse(
            SpaPodFilter.Matches(
                candidate,
                Obj(Prop(1, Step(new SpaLong(0), new SpaLong(0), new SpaLong(100), new SpaLong(7))))
            )
        );
        Assert.IsFalse(
            SpaPodFilter.Matches(
                candidate,
                Obj(Prop(1, Step(new SpaLong(0), new SpaLong(0), new SpaLong(100), new SpaLong(0))))
            )
        );
    }
    ...
    public void RangeFilters_CompareStringsOrdinally()
    {
        ...
        Assert.IsTrue(
            SpaPodFilter.Matches(
                candidate,
                Obj(Prop(1, Range(new SpaString("a"), new SpaString("a"), new SpaString("c"))))
            )
        );
        Assert.IsFalse(
            SpaPodFilter.Matches(
                Obj(Prop(1, new SpaString("z"))),
                Obj(Prop(1, Range(new SpaString("a"), new SpaString("a"), new SpaString("c"))))
            )
        );
    }
    ...
    public void RangeAgainstRange_ComparesRectanglesByArea()
    {
        ...
        SpaObject candidate = Obj(
            Prop(1, Range(new SpaRectangle(4, 6), new SpaRectangle(2, 12), new SpaRectangle(8, 3)))
        );
            ...
            SpaPodFilter.Matches(
                ...
                Obj(
                    Prop(
                        1,
                        Range(
                            new SpaRectangle(4, 6),
                            new SpaRectangle(3, 8),
                            new SpaRectangle(6, 4)
                        )
                    )
                )
            )
            ...
            SpaPodFilter.Matches(
                ...
                Obj(
                    Prop(
                        ...
                        Range(
                            new SpaRectangle(4, 6),
                            new SpaRectangle(9, 9),
                            new SpaRectangle(10, 10)
                        )
                    )
                )
            )
    ...
    {
        Assert.IsTrue(
            SpaPodFilter.Matches(Obj(Prop(1, new SpaBool(true))), Obj(Prop(1, new SpaBool(true))))
        );
        Assert.IsFalse(
            SpaPodFilter.Matches(Obj(Prop(1, new SpaBool(true))), Obj(Prop(1, new SpaBool(false))))
        );
        Assert.IsTrue(SpaPodFilter.Matches(Obj(Prop(2, new SpaId(7))), Obj(Prop(2, new SpaId(7)))));
        Assert.IsFalse(
            SpaPodFilter.Matches(Obj(Prop(2, new SpaId(7))), Obj(Prop(2, new SpaId(8))))
        );
    }
}
