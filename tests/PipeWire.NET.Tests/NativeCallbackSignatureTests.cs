...
public sealed class NativeCallbackSignatureTests
{
    ...
    public void EveryShippedAssembly_DisablesRuntimeMarshalling()
    {
        ...
        {
            Assert.IsNotNull(
                assembly.GetCustomAttribute<DisableRuntimeMarshallingAttribute>(),
    ...
    public void EveryNativeCallback_HasASignatureTheRuntimeAccepts()
    {
        ...
        {
            bool relaxed =
                assembly.GetCustomAttribute<DisableRuntimeMarshallingAttribute>() is not null;
    ...
    {
        if (t == typeof(void) || t.IsPointer || t.IsFunctionPointer || t.IsUnmanagedFunctionPointer)
            return true;
        if (t == typeof(bool) || t == typeof(char))
            return relaxed;
        if (t.IsPrimitive || t.IsEnum)
            return true;
        if (t.IsValueType)
            return IsUnmanagedStruct(t);
        return false;
    }
