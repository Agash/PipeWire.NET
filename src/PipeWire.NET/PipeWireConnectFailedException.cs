...
public sealed class PipeWireConnectFailedException : PipeWireConnectionException
{
    ...
    public PipeWireConnectFailedException(
        string operation,
        int result,
        uint? objectId = null,
    ...
    /// <inheritdoc/>
    public PipeWireConnectFailedException(string message)
        : base(message) { }

    /// <inheritdoc/>
    public PipeWireConnectFailedException(string message, Exception innerException)
