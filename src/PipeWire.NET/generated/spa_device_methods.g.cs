...
internal unsafe partial struct spa_device_methods
{
    [NativeTypeName("uint32_t")]
    public uint version;

    [NativeTypeName("int (*)(void *, struct spa_hook *, const struct spa_device_events *, void *)")]
    public delegate* unmanaged[Cdecl]<void*, spa_hook*, spa_device_events*, void*, int> add_listener;
