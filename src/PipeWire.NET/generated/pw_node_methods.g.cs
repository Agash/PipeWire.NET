...
internal unsafe partial struct pw_node_methods
{
    [NativeTypeName("uint32_t")]
    public uint version;

    [NativeTypeName("int (*)(void *, struct spa_hook *, const struct pw_node_events *, void *)")]
    public delegate* unmanaged[Cdecl]<void*, spa_hook*, pw_node_events*, void*, int> add_listener;
