...
public readonly struct PipeWireNodeBuilder
{
    ...
    public PipeWireNodeBuilder WithName(string name)
    {
    ...
    /// </remarks>
    public PipeWireNodeBuilder WithLinger() =>
    ...
    /// </exception>
    public PipeWireNodeBuilder WithProperty(string key, string value)
    {
    ...
    /// </remarks>
    public PipeWireNodeBuilder WithMediaClass(string mediaClass) =>
    ...
    /// </remarks>
    public PipeWireNodeBuilder WithChannelPositions(string positions) =>
    ...
    public PipeWireNodeBuilder WithTarget(PipeWireNode node)
    {
    ...
    /// </param>
    public PipeWireNodeBuilder WithTarget(string nameOrSerial)
    {
    ...
    /// </remarks>
    public PipeWireNodeBuilder WithAutoConnect(bool autoConnect) =>
    ...
    /// </para>
    /// </remarks>
    public PipeWireNodeBuilder WithDontReconnect() =>
