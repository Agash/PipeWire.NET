// Hand-maintained half of the generated `NativeConstants` partial class: the DRM syncobj timeline
// calls from libdrm that back explicit sync.
//
// Hand-written for the reason NativeConstants.Libc.cs gives, which applies here unchanged: errno is
