// Hand-maintained half of the generated `NativeConstants` partial class.
//
// generate/generate.sh wipes generated/ on every run, so anything hand-written lives here. The
// class is the same one generate/constants.rsp emits, so a caller sees these alongside the
// generated PW_KEY_*/SPA_KEY_* spans and the generated PosixTimespec without knowing which half
// declared what.
//
...
internal static unsafe partial class NativeConstants
{
